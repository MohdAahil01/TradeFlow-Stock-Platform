    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 style={{ fontWeight: "400" }}><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 style={{ fontWeight: "400" }} lassName="">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 style={{ fontWeight: "400" }}>
            <i class="fa fa-grav" aria-hidden="true"></i> Coin
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
